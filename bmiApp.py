...
# ส่วนที่ 2 สร้างช่องรับค่าน้ำหนัก และ ส่วนสูง (กำหนด min_value และ value เริ่มต้นเพื่อป้องกันค่า 0)
weight = st.number_input("กรอกน้ำหนักของคุณ (กิโลกรัม):", min_value=1.0, value=60.0)
height_cm = st.number_input("กรอกส่วนสูงของคุณ (เซนติเมตร):", min_value=1.0, value=170.0)

# ส่วนที่ 3 สร้างปุ่มกดคำนวณ และย้ายการแสดงผลทั้งหมดมาไว้ในบล็อก if
