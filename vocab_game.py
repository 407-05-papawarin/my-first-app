...
ans3 = st.text_input(
    "ข้อ 3: Monkeys'favorite food is `_ _ n _ _ a`. 🍌",
    value=st.session_state.ans3_val,
)
ans4 = st.text_input(
    "ข้อ 4: Purple fruit is `b _ _ e _ _ r r _` Its circular in shape and edible. 🫐",
